...
<body>
  ...
  <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-400">Book A Table</h2>

  <!-- Form creation code goes here -->

  <!-- Button and link -->
  <a href="{{ route('form.create') }}"> <!-- Replace "your-form-id" with the actual ID of your form -->
